...
<?php foreach ($cartlist as $v) { ?>
    <tr>
        <td>
            <a href="<?php echo U('Index/detail',array('goods_id'=>$v['goods_id']))?>" target="_blank" class="f6"><?php echo $v['info']['goods_name'] ?></a>
        </td>
...
<?php
                            ...
                            <tr>
                                <td colspan="7">
                                    购物金额小计 ￥<?php echo $total['total_price']?>元，比市场价 ￥<?php echo $total['total_price']*1.2?>元 节省了 ￥1002.00元 (17%)              </td>
                            </tr>
                        </tbody></table>
                </div>
                <div class="blank"></div>
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                                <td>收货人姓名:</td>
                                <td><?php echo $consignee_info['consignee']?></td>
                                <td>电子邮件地址:</td>
                                <td>shuhua141@163.com</td>
                            </tr>
                            <input type="hidden" name="consignee" value="<?php echo $consignee_info['consignee']?>" />
                            <input type="hidden" name="address" value="<?php echo $consignee_info['address']?>" />
                            <input type="hidden" name="mobile" value="<?php echo $consignee_info['mobile']?>" />
                            <tr>
                                <td>详细地址:</td>
                                <td><?php echo $consignee_info['address']?> </td>
                                <td>邮政编码:</td>
                                <td><?php echo $consignee_info['post']?></td>
                            </tr>
                            <tr>
                                <td>电话:</td>
                                <td>010-80678115 </td>
                                <td>手机:</td>
                                <td><?php echo $consignee_info['mobile']?></td>
                            </tr>
                            <tr>
                                <td>标志建筑:</td>
                                <td>朝阳门</td>
                        ...
                        <tbody><tr>
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <td valign="top">在线支付，要先开通网上银行。</td>
                                <td align="right" valign="top">￥0.00元</td>
                            </tr>
