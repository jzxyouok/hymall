    ...
    <body class="index_body">
        ...
        <div class="block clearfix">
            ...
            <div class="AreaL">
                ...
                <?php foreach ($cat_list as $v) { if($v['parent_id']==0){ ?>
                    <dl>
                    <!-- 先取顶级栏目 -->
                        <dt><a href="<?php echo U('category',array('cat_id'=>$v['cat_id']))?>"><?php echo $v['cat_name']?></a></dt>
                        <dd>  
                           <!--再取子级栏目  -->
                            <?php foreach($cat_list as $v1){ if($v1['parent_id']==$v['cat_id']){ ?>
                                <a href="<?php echo U('category',array('cat_id'=>$v1['cat_id']))?>"><?php echo $v1['cat_name']?></a>
                            <?php
 } }?>
                        </dd>
                    </dl>
            ...
            <div class="AreaM">
                ...
                <div id="show_hot_area" class="clearfix">
                    <?php foreach ($goods_hot_list as $v) { ?>
                      <div class="goodsItem">
                ...
                <div id="show_hot_area" class="clearfix">
                    <?php foreach ($goods_new_list as $v) { ?>
                      <div class="goodsItem">
