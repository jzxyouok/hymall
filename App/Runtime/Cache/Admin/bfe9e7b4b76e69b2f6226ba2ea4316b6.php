...
<div class="container">
    ...
    <div class="panel panel-success">
       <div class="panel-heading"> <h1 class="page-header text-center">修改角色</h1></div>
      <div class="panel-body">
          <div class="col-md-6 col-md-offset-3">
            <form action="/index.php/Admin/Role/update/role_id/1.html" method="post" class="form-horizontal">
                <!--单行文本域-->
                  <div class="form-group has-success">
                    ...
                    <div class="col-md-8">
                      <input type="text" value="<?php echo $role_info['role_name']?>" name="role_name" id="role_name" class="form-control"/>
                    </div>
                  </div>
                ...
                <div class="form-group has-success">
                  ...
                  <?php foreach ($priv_list as $v) { ?>
                    <div class="checkbox" style="margin-left:<?php echo $v['lev']*30?>px">
                      <label>
                        <input type="checkbox" <?php foreach ($priv_info as $p) { if($p['priv_id']==$v['priv_id']){echo 'checked';break;} }?> value="<?php echo $v['priv_id']?>" name="priv[]" id="" /><?php echo $v['priv_name']?>
                      </label>
                    </div>
                  <?php
 }?> 
