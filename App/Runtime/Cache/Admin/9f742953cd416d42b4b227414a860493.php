...
<div class="container">
    ...
    <!--类navbar-header导航条标题-->
      ...
      <h1 class="page-header text-center">添加权限</h1>

    <div class="col-md-6 col-md-offset-3">
        <form action="/index.php/Admin/Privilege/add.html" method="post" class="form-horizontal">
            <!--单行文本域-->
              <div class="form-group has-success">
                ...
                <div class="col-md-8">
                  <input type="text" name="priv_name" id="priv_name" class="form-control"/>
                </div>
              </div>
                ...
                <div class="col-md-8">
                  <select name="parent_id" id="parent_id" class="form-control">
                    ...
                    <?php foreach($priv_list as $rows){ ?>
                      <option value="<?php echo $rows['priv_id']?>"><?php echo str_repeat('&nbsp;', $rows['lev']*6), $rows['priv_name']?></option>
                    <?php
 } ?>
                  </select>
                </div>
              ...
              <div class="form-group has-success">
                ...
                <div class="col-md-8">
                  <input type="text" name="action_name" id="action_name" class="form-control"/>
                </div>
              </div>
