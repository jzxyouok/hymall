...
<div class="container">
    ...
    <h1 class="page-header text-center">添加商品类型</h1>

    <div class="col-md-6 col-md-offset-3">
        <form action="/index.php/Admin/Type/add.html" method="post" class="form-horizontal">
            <!--单行文本域-->
    ...
    <div class="footer" style="margin-top:250px;background-color:#ccc">
