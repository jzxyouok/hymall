<?php if (!defined('THINK_PATH')) exit();?><table class="table table-striped table-hover table-condensed">
	<tr>
		<th>商品名称</th>
		<th>货号</th>
		<th>价格</th>
	...
	<tr>
		<td><img src="<?php echo C('IMG_SRC').$v['info']['goods_thumb']?>"><br><?php echo $v['goods_name']?></td>
