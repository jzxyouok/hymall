...
<head>
    ...
    <style>
        body{
          padding-top: 50px;    /*菜单固定在顶部，内容会钻到下面去，给body加内填充把内容挤下去*/
        }
         .navbar{
...
<div class="container">
    ...
    <!--类navbar-header导航条标题-->
        ...
        <h1 class="page-header text-center">修改商品属性</h1>
    <div class="col-md-8 col-md-offset-1">
        <form action="/index.php/Admin/Attribute/update/attr_id/10/p/1.html" method="post" class="form-horizontal">
            <!--单行文本域-->
              <div class="form-group has-success">
                ...
                <div class="col-md-8">
                  <input type="text" value="<?php echo $info['attr_name']?>" name="attr_name" id="attr_name" class="form-control"/>
                </div>
              </div>
              ...
              <div class="form-group has-success">
                ...
                <div class="col-md-8">
                  <div class="radio-inline">
                    <label>
                      <input type="radio" value="0" name="attr_type" <?php echo $info['attr_type']==0?'checked':''?>/>唯一属性
                    </label>
                  </div>
                  <div class="radio-inline">
                    <label>
                      <input type="radio" value="1" name="attr_type" <?php echo $info['attr_type']==1?'checked':''?> />单选属性
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group has-success">
                ...
                <div class="col-md-8">
                  <div class="radio-inline">
                    <label>
                      <input type="radio" value="0" name="attr_input_type" <?php echo $info['attr_input_type']==0?'checked':''?>/>手工录入
                    </label>
                  </div>
                  <div class="radio-inline">
                    <label>
                      <input type="radio" value="1" name="attr_input_type" <?php echo $info['attr_input_type']==1?'checked':''?> />从下面的列表中选择（多个用逗号隔开）
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group has-success">
                ...
                <div class="col-md-8">
                  ...
                  class="form-control input-lg" ><?php echo $info['attr_value']?></textarea>
                </div>
              </div>
