...
<div class="container">
    ...
    <!--类navbar-header导航条标题-->
      ...
      <h1 class="page-header text-center">添加商品栏目</h1>

    <div class="col-md-6 col-md-offset-3">
        <form action="/index.php/Admin/Category/add.html" method="post" class="form-horizontal">
            <!--单行文本域-->
                ...
                <div class="col-md-8">
                  <select name="parent_id" id="parent_id" class="form-control">
                    ...
                    <?php foreach($cat_list as $rows){ ?>
                      <option value="<?php echo $rows['cat_id']?>"><?php echo str_repeat('&nbsp;', $rows['lev']*4), $rows['cat_name']?></option>
                    <?php
 } ?>
                  </select>
                </div>
