...
<div class="navbar navbar-fixed-top">
    <!--类navbar-header导航条标题-->
        ...
        <div class="collapse navbar-collapse" id="myheader">
          ...
          <p class="navbar-text" style="font-size:18px">商品栏目</p>
          <a href="<?php echo U('add')?>" class="btn btn-default navbar-btn navbar-right" style="margin-right:20px">添加商品栏目</a>
...
<table width="100%" class="table table-striped table-hover table-condensed" id="list-table">
  <tr>
    <th>分类名称</th>
    <th>商品数量</th>
    <th>数量单位</th>
    ...
    <th>操作</th>
      ...
      <?php foreach($cat_list as $rows){ ?>
        ...
        <td width="24%" align="center">
          <a href="#">转移商品</a> |
          <a href="<?php echo U('update',array('cat_id'=>$rows['cat_id']))?>">编辑</a> |
          <a href="<?php echo U('del',array('cat_id'=>$rows['cat_id']))?>" onclick="return confirm('确定删除吗')" title="移除">移除</a>
        </td>
      </tr>
        <?php
 }?>
